        ...
        <div class="block-heading">
           ...
           <form>
            <table id="tabelavagas" class="table">
              ...
              <tr>
                        <td style="background-color: #ffffff;"> <?php echo $e->bay_id ; ?></td>  
                        <td style="background-color: #ffffff;"><?php echo $e->st_marker_id; ?> </td>
                        <td style="background-color: #ffffff;"><?php echo $e->status; ?> </td>
                        <td style="background-color: #ffffff;"> <?php echo $e->lat; ?> </td>
                        <td style="background-color: #ffffff;"> <?php echo $e->lon; ?> </td>
