        ...
        <section class="clean-block clean-info dark" style="background-color: rgb(255,255,255);">
            <div class="container" style="filter: brightness(100%);">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <iframe allowfullscreen="" frameborder="0" width="100%" height="400" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyCDbrzMyacs8Gt3ik9pM1NNqpwsQzOmFpo&amp;q=melbourne%2C+Australia&amp;zoom=11">
                            
                        </iframe></div>
                    <div class="col-md-6"
                        style="padding-bottom: 151px;background-color: #ffffff;">
